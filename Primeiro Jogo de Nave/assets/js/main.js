...
function start() {
    ...
    function moveJogador() {
        ...
        if (jogo.pressionou[TECLA.E]) {
            $("#jogador").html(window.location.href = 'index.html');
        }
	...
	function gameOver() {
        ...
        $("#fim").html("<h1> Game Over </h1><p>Sua pontuação foi: " + pontos + "</p>" + "<button id='botao' onclick='reiniciaJogo()'>REINICIAR</button>");
    }
